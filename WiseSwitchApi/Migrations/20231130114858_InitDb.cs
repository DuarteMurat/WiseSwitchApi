        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductSeries_ProductLines_ProductLineId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultFirmwareVersionId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SwitchModels_FirmwareVersions_DefaultFirmwareVersionId",
                        column: x => x.DefaultFirmwareVersionId,
                        principalTable: "FirmwareVersions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SwitchModels_ProductSeries_ProductSeriesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SwitchModels_DefaultFirmwareVersionId",
                table: "SwitchModels",
                column: "DefaultFirmwareVersionId");

            migrationBuilder.CreateIndex(
                name: "IX_SwitchModels_ProductSeriesId",
                table: "SwitchModels",
